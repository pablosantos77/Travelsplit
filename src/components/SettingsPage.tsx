  ...
  return (
    <div className="bg-[#f7f9fb] text-[#191c1e] min-h-screen flex flex-col pb-32 w-full font-sans">
      ...
      <main className="flex-grow px-6 py-8 max-w-md mx-auto w-full space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-lg font-semibold text-[#495770] tracking-tight px-1">{t.appearance}</h2>
          <div className="bg-white rounded-xl p-4 shadow-[0px_12px_32px_rgba(25,28,30,0.04)] border border-slate-100 flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-[#191c1e]">{t.appearance}</h3>
              <p className="text-sm text-[#424656]">{t.appearanceDesc}</p>
            </div>
