        ...
        <div className="hidden md:block w-1/2 h-[600px] relative overflow-hidden border-r border-[#1f2130]">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0f1120] to-[#151929]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
              ...
              >
                {t.subtitle || "Sign in to access your global travel dashboard and connect with nomads worldwide"}
              </motion.p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
          ...
          >
            <h1 className="text-2xl md:text-3xl font-bold mb-1">
              {authMode === 'login' ? (t.loginWelcome || "Welcome back") : (t.registerWelcome || "Join us")}
            </h1>
            <p className="text-gray-400 mb-8">
              {authMode === 'login' ? (t.loginSubtitle || "Sign in to your account") : (t.registerSubtitle || "Create your account")}
            </p>
            ...
            <div className="mb-6">
              ...
              >
                ...
                <span>{t.google || "Login with Google"}</span>
              </button>
            </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-[#090b13] text-gray-400">{t.orEmail || "or"}</span>
              </div>
            </div>
            ...
            <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); onEmailAuth(); }}>
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-300 mb-1">
                  {t.passwordLabel || "Password"} <span className="text-blue-500">*</span>
                </label>
                <div className="relative">
                  <Input
                    ...
                    placeholder={t.passPlaceholder || "Enter your password"}
                    required
                ...
                >
                  <span className="flex items-center justify-center">
                    {authLoading ? (
                      ...
                      <>
                        {authMode === 'login' ? (t.login || "Sign in") : (t.register || "Sign up")}
              ...
              <div className="text-center mt-6 flex flex-col gap-3">
                ...
                >
                  {authMode === 'login' ? (t.noAccount || "Don't have an account? Sign up") : (t.hasAccount || "Already have an account? Sign in")}
                </button>
