...
export const Background: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 w-full h-full z-0 pointer-events-none flex items-center justify-center bg-white overflow-hidden">
      <video 
        ref={videoRef}
        autoPlay 
        loop 
        muted 
        playsInline 
        className="w-[140%] h-[140%] object-cover blur-[60px] scale-125 transform-gpu opacity-70"
      >
