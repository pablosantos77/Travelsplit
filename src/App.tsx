  ...
  if (!user) {
    ...
    return (
      <div className="min-h-[100dvh] w-full flex flex-col items-center justify-center bg-slate-50 relative overflow-hidden text-slate-800 font-sans selection:bg-[#004ccc]/20 px-6">
        ...
        <div className="z-10 w-full max-w-[400px] animate-scaleUp">
          ...
          <div className="relative bg-white/80 backdrop-blur-2xl rounded-[32px] shadow-[0_24px_48px_rgba(0,0,0,0.06)] border border-white overflow-hidden">
            ...
            <div className="relative z-10 p-8 space-y-6">
              ...
              {authError && (
                <div className="bg-[#ba1a1a]/5 text-[#ba1a1a] text-[12px] font-bold px-4 py-3 rounded-xl flex items-center gap-2 border border-[#ba1a1a]/10 slide-in-from-top-1 animate-in">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full bg-[#004ccc] text-white h-[56px] rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center shadow-[0_8px_24px_rgba(0,76,204,0.3)] active:scale-[0.98] transition-all disabled:opacity-70"
                >
                  {authLoading ? (
                ...
                <button
                  ...
                  className="w-full text-center text-[11px] font-black text-slate-400 uppercase tracking-widest mt-6 hover:text-[#004ccc] transition-colors"
                >
