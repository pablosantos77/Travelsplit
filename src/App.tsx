    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#f4f7f9]">
        <div className="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-slate-100">
          <h1 className="text-2xl font-extrabold mb-2 text-[#0066ff]">TravelSplit AI</h1>
          <p className="text-sm text-[#6c757d] mb-8">Inicia sesión con tu cuenta de Google para continuar.</p>
          <button onClick={handleGoogleLogin} className="w-full bg-[#1a1c1e] text-white py-3 rounded-xl font-bold flex items-center justify-center gap-2 mb-4">
